	...
	throws IOException, ServletException{
		 ...
		 if(command.equals("/memberLogin.me")){
			 ...
			 forward.setPath("./member/member_out.jsp");
				...
				forward = new ActionForward();
				forward.setPath("./member/member_loginok.jsp");
		 ...
		 }else if(command.equals("/MemberOrderListAction.me")){
		 ...
		 }else if(command.equals("/MemberDeliveryAction.me")){
			 action  = new MemberDeliveryAction();
			 try {
				 forward=action.execute(request, response);
			 } catch (Exception e) {
				 e.printStackTrace();
			 }
		 }else if(command.equals("/MemberPointListAction.me")){
		 ...
		 }else if(command.equals("/MemOrderDetailAction.me")){
			 action  = new MemOrderDetailAction();
			 try {
				 forward=action.execute(request, response);
			 } catch (Exception e) {
				 e.printStackTrace();
